 ...
 */
var withSplashScreen = function (config) {
 ...
 */
var withAndroidSplashScreen = function (config) {
 ...
 */
var withCustomStringsXml = function (config) {
    return (0, config_plugins_1.withStringsXml)(config, function (modConfig) {
 ...
 */
var withCustomStylesXml = function (config) {
    return (0, config_plugins_1.withAndroidStyles)(config, function (modConfig) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            modConfig.modResults = config_plugins_1.AndroidConfig.Styles.assignStylesValue(modConfig.modResults, {
                add: true,
